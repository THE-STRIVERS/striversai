...
# Setup AI Services - FIXED VERSION
def setup_ai_services():
    """Initialize AI services with error handling"""
    services_status = {}
    
    # OpenAI Client Setup - FIXED: Remove proxies parameter
    try:
        if OPENAI_API_KEY:
        ...
        if "proxies" in error_msg:
            ...
            services_status['openai'] = f"Error: {error_msg}"
    ...
    try:
        if ELEVENLABS_API_KEY:
            ...
            try:
                ...
                if "Free Tier" in str(api_error) or "abuse" in str(api_error).lower():
